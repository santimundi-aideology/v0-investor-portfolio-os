...
export default async function RealtorMarketSignalsPage() {
  ...
  return (
    <div className="space-y-8">
      <div className="rounded-2xl bg-gradient-to-br from-teal-50 via-white to-blue-50 border border-gray-100 p-8 shadow-sm">
        <PageHeader
          title={
            <span className="flex items-center gap-3">
              <span className="inline-flex size-12 items-center justify-center rounded-xl bg-teal-500 text-white shadow-lg">
          ...
          badges={
            <>
              ...
              <Badge variant="outline" className="bg-white/80 backdrop-blur-sm gap-2 border-teal-200 text-teal-700">
