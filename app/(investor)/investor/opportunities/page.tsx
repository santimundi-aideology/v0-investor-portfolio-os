...
function OpportunityCard({
  ...
  return (
    <Card
      ...
      aria-label={
        opportunity.memoId
          ? `Open ${p?.title ?? "opportunity"} IC memo`
          : `Open ${p?.title ?? "opportunity"} details`
      }
    >
      {/* Property header */}
      <Link href={primaryHref} className="relative block h-36 bg-muted">
        {p?.imageUrl ? (
          <img
            src={p.imageUrl}
      ...
      <CardContent className="p-4 space-y-3">
        ...
        {/* Decision controls */}
        <div className="flex flex-wrap items-center gap-2 pt-1 border-t" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center gap-2 pt-1" onClick={(e) => e.stopPropagation()}>
          ...
          {!opportunity.memoId && (
            <span className="text-[10px] text-muted-foreground">IC memo pending from advisor</span>
          )}
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4">
            ...
            <AskAIBankerWidget
              ...
              suggestedQuestions={[
                "Which opportunities best match my mandate?",
              ...
              {items.length > 0 ? (
                ...
                <Card className="p-12 text-center">
                  ...
                  <h3 className="mt-4 text-lg font-semibold">
                    No {value === "new" ? "new opportunities" : `${value} opportunities`} yet
                  </h3>
